    ...
    <ScrollView style={{flex: 1}}>
      <Box>
        ...
        <Value initial={false}>
          {({value, set}) => (
            <Control
              options={[{icon: Icons.Logo, value: true}]}
              selected={value}
              onSelect={() => set(!value)}
            />
          )}
        ...
        <Card>
          ...
          <Spacer size="s" />
          <Text>
            A card is a flexible and extensible content container. It contains
        ...
        <Spacer />
        <Paragraph size="l">
          A Vela surgiu com o propósito de oferecer uma solução eficiente para o
          transporte urbano. Atualmente, transformamos o meio de locomoção
          diário de 1800 pessoas através da bicicleta elétrica. Quais os motivos
          que influenciam na escolha de pedalar?
        </Paragraph>
        <Paragraph>
          A partir do estudo “Impacto Social do Uso da Bicicleta em São Paulo”,
          desenvolvido pelo CEBRAP e Itaú, conseguimos mensurar os benefícios do
          ciclismo em três áreas: meio ambiente, saúde e economia.
        </Paragraph>
        <Paragraph>
          Ainda de acordo com o estudo, quem vai de bike diminui o estresse, o
          desconforto e aumenta o prazer em 20%, durante o deslocamento, quando
          comparado com outras modalidades. Logo, ciclistas tendem a ter uma
          experiência mais positiva nos espaços públicos.
        </Paragraph>
        <Spacer size="xl" />
      </Box>
    </ScrollView>
